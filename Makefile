...
include scripts/makefiles/golang.mk
include scripts/makefiles/generate.mk
include scripts/makefiles/image.mk
...
#.PHONY: swagger
#swagger: tools.verify.swagger ## 启动 swagger 在线文档（监听端口：8080）.
#	@swagger serve -F=swagger --no-open --port 8080 $(ROOT_DIR)/api/openapi/openapi.yaml
